  ...
  <div id="content" class="container-fluid p-5">
    ...
    <div class="jumbotron text-center"  style="background: #F4FBFF;">
      <div class="container">
        ...
        <i class="fas fa-user-secret"></i> - REPRESENTANTE</h2><hr>
        <p class="lead">Aplicacion de rutas municipales | Administra los representantes</p>
      </div>
    </div>  
...
<form action="" method="POST">
    <div class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
      <div class="modal-dialog" role="document">
        <div class="modal-content">
        <div class="modal-header" style="background:#40A5F5;">
          <h5 class="modal-title" id="exampleModalScrollableTitle">Inserta un Representante</h5>
          <button type="button" class="close" data-dismiss="modal" aria-label="Close">
            <span aria-hidden="true">&times;</span>
          </button>
        </div>
    ...
    <div class="jumbotron text-center"  style="background: #F4FBFF;">
        ...
        <form action="" method="POST">
            ...
            <div class="form-group row">
                <label class="col-sm-3 col-form-label">Correo: </label>
                <div class="col-sm-6">
                <input class="form-control" type="hidden" name="Correo" value="<?php echo $A[1]; ?>">
                <label><?php echo $A[1]; ?></label>
                </div>
            </div>  
            ...
            <div class="form-group row">
                ...
                <button type="button" class="btn btn-danger" onclick=' location.href="Representante.php" '>Cerrar</button>
