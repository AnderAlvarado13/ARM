  ...
  <div id="content" class="container-fluid p-5">
    ...
    <div class="jumbotron text-center"  style="background: #F4FBFF;">
      <div class="container">
        ...
        <i class="fas fa-user-tag"></i> - DATOS PERSONALES</h2><hr>
        <p class="lead">Aplicacion de rutas municipales | Administra los datos personales</p>
      </div>
    </div>  
        ...
        <div class="table-responsive">
            ...
            <?php foreach($Perfil as $A){ ?>
                <tr>
                    ...
                    <td><?php echo $A[3]; ?></td>
                    <td><?php echo $A[4]; ?></td>
                    <td><img src="Imagenes/<?php echo $A[5]; ?>" width="35px" height="35px"></td>
...
<form action="" method="POST" enctype="multipart/form-data">
    <div class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
      <div class="modal-dialog" role="document">
        <div class="modal-content">
        <div class="modal-header" style="background:#40A5F5;">
          <h5 class="modal-title" id="exampleModalScrollableTitle">Inserta un Perfil</h5>
          <button type="button" class="close" data-dismiss="modal" aria-label="Close">
            <span aria-hidden="true">&times;</span>
          </button>
        </div>
        ...
        <div class="modal-body">  
            ...
            <div class="form-group row">
                ...
                <select name="Correo" class="form-control">
                    ...
                    <option  value="<?php echo $u[0];?>"> <?php echo $u[0];?></option> 
                    <?php } ?>
                </select>
                </div>
            </div>
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-6">
                <input type="text" name="Nombres" placeholder="Digite su Nombres" class="form-control">
                </div>
            </div>
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-6">
                <input type="text" name="Apellidos" placeholder="Digite su Apellidos" class="form-control">
                </div>
            </div>
    ...
    <div class="jumbotron text-center"  style="background: #F4FBFF;">
        ...
        <form action="" method="POST" enctype="multipart/form-data">
            <?php foreach ($data as $A) { ?>
                ...
                <label class="col-sm-3 col-form-label">Correo</label>
                <div class="col-sm-6">
                <input type="hidden" name="Correo"  value="<?php echo $A[0]; ?>" class="form-control">
            ...
            <div class="form-group row">
                ...
                <button type="button" class="btn btn-danger" onclick=' location.href="Perfil.php" '>Cerrar</button>
