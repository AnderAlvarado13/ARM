  ...
  <div id="content" class="container-fluid p-5">
    ...
    <div class="jumbotron text-center"  style="background: #F4FBFF;">
      <div class="container">
        ...
        <i class="fas fa-house-user"></i> - EMPRESA</h2><hr>
        <p class="lead">Aplicacion de rutas municipales | Administra las empresas</p>
      </div>
    </div>  
    ...
    <div class="jumbotron text-center"  style="background: #F4FBFF;">
        ...
        <form action="" method="POST" enctype="multipart/form-data">
            ...
            <div class="form-group row">
                ...
                <button type="button" class="btn btn-danger" onclick=' location.href="Empresa.php" '>Cerrar</button>
