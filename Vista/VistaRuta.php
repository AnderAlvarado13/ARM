  ...
  <div id="content" class="container-fluid p-5">
    ...
    <div class="jumbotron text-center"  style="background: #F4FBFF;">
      <div class="container">
        ...
        <i class="fas fa-car"></i> - RUTAS</h2><hr>
        <p class="lead">Aplicacion de rutas municipales | Administra las rutas</p>
      </div>
    </div>  
      ...
      <div class="modal-dialog" role="document">
        ...
        <div class="modal-body">
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-6">
                <input type="text" name="Horarios" placeholder="Digite su Nombre" class="form-control">
                </div>
            </div>         
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-6">
                <input type="text" name="Precio" placeholder="Digite su Nombre" class="form-control">
                </div>
            </div>               
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-6">
                <input type="file" name="Tablilla" lang="es" accept="image/jpeg, image/jpg, image/gif, image/png, application/pdf">
                </div>
            </div>  
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-6">
                <input type="file" name="Bus" lang="es" accept="image/jpeg, image/jpg, image/gif, image/png, application/pdf">
                </div>
            </div>             
    ...
    <div class="jumbotron text-center"  style="background: #F4FBFF;">
        ...
        <form action="" method="POST" enctype="multipart/form-data">
            ...
            <div class="form-group row">
                ...
                <button type="button" class="btn btn-danger" onclick=' location.href="Ruta.php" '>Cerrar</button>
